...
class Groups
{
	...
	function saveInformation($id, $name, $information, $district, $product, $sender)
	{
		...
		$sql = "INSERT INTO groups SET name = '$name',urlname='$name',contents = '$information',linkType = 'Information',district = '$district',information_type = '$information_type',sender='$sender', publish='No', onDate = NOW()";
		//echo $sql; die();
		$conn->exec($sql);
		if($id > 0)
			return $conn -> affRows();
