...
if(isset($_POST['btnSubmit']))
{
 ...
 elseif(isset($_SESSION['sessMgrname']))
 {
  if(!$users -> validateMgrPassword($_SESSION['sessMgrId'],$opsw))
  {
 ...
 if(isset($_SESSION['sessMgrname']))
 {
  if(empty($errMsg))
  { echo "hi";
   $chPsw = $users -> updatePassword($_SESSION['sessMgrId'],$npsw);
   if($chPsw)
   {
