...
<?
	...
	$conn = new Dbconn();
	mysql_query("delete from riverwatch");
        mysql_query("ALTER TABLE riverwatch AUTO_INCREMENT = 1");
?>
<?
	...
	for($i=0;$i<count($riverwatch);$i++)
	{
		...
		$sql=mysql_query("insert into riverwatch set stationIndex='$stationIndex', stationName='$stationName', dateTime='$dateTime', 
