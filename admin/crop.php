                          ...
                          <?php } ?>                          
                            ...
                            <tr>
                              ...
                              <td colspan="2" style="width:400px">
                								<textarea id="shortcontents" name="shortcontents"><?=$shortcontents;?>
                                </textarea>
							...
							{?>
                                <tr>
                                  ...
                                  <td><img src="../<?= CMS_GROUPS_DIR.$editRow['image']; ?>" width="150" height="132" />
                    ...
                    <tr>
                      	<td class="heading2">
							...
							if (!isset($_GET['categoryId'])){
								...
								$category=mysql_fetch_array(mysql_query("select name from groups where id='$categoryId'")); 
