...
<?
	...
	$conn = new Dbconn();
	mysql_query("delete from rainfall");
        mysql_query("ALTER TABLE rainfall AUTO_INCREMENT = 1");
?>
<?
	...
	for($i=0;$i<count($rainfall);$i++)
	{
		...
		$sql=mysql_query("insert into rainfall set basinName='$basinName', stationIndex='$stationIndex', stationName='$stationName', 
