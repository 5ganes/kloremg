...
elseif(isset($_GET['id']))
	...
	$id = 0;
$weight = $undp -> getAgrinewsSubLastWeight();
//echo $weight;
if($_GET['type'] == "edit")
{
	$result = $undp->getAgrinewsById($_GET['id']);
...
{
	extract($_POST);
	$pid = $undp -> saveAgrinews($id, $name, $description, $newsDate, $newsSource, $publish, $weight);

	if($id>0)
		header("Location: agrinews.php?type=edit&id=$id&msg=Agrinews details updated successfully");
	else
		header("Location: agrinews.php?msg=Agrinews details saved successfully");
	exit();
			
}
if($_GET['type']=="del")
{
		$undp -> deleteAgrinews($_GET['id']);?>
    	<script> document.location='agrinews.php?&msg=Insurance deleted successfully.' </script>    
<? }
?>
          ...
          <td class="bgborder"><table width="100%" border="0" cellspacing="1" cellpadding="0">
              <tr>
                <td bgcolor="#fff"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                      <td class="heading2">&nbsp; Manage  Agriculture News
                        <div style="float: right;">
                          <?
							$addNewLink = "agrinews.php";
						  ?>
                    ...
                    <tr>
                      ...
                      <table width="100%" border="0" cellpadding="2" cellspacing="0">
                          ...
                          <?php } ?>                          
                            ...
                            <tr>
                              <td>&nbsp;</td>
                              <td class="tahomabold11"><strong> News Title : <span class="asterisk">*</span></strong></td>
                              <td>
                            ...
                            <tr>
                              <td>&nbsp;</td>
                              <td class="tahomabold11"><strong> News Date : <span class="asterisk">*</span></strong></td>
                              <td>
                                <input type="text" name="newsDate" value="<?php echo $newsDate; ?>" id="nepaliDate" class="nepali-calendar text" 
                            ...
                            <tr>
                              <td>&nbsp;</td>
                              <td class="tahomabold11"><strong> News Source : <span class="asterisk">*</span></strong></td>
                              <td>
                                <input name="newsSource" type="text" class="text" value="<?= $newsSource; ?>" required="required" /></td>
                            </tr>
                            <tr><td></td></tr>
          ...
          <td class="bgborder"><table width="100%" border="0" cellspacing="1" cellpadding="0">
              <tr>
                <td bgcolor="#FFFFFF"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                      <td class="heading2">&nbsp;Agriculture News List</td>
                    </tr>
                    <tr>
                      <td><table width="100%"  border="0" cellpadding="4" cellspacing="0">
                          <tr bgcolor="#F1F1F1" class="tahomabold11">
                            ...
                            <td style="width:148px"> Title </td>
                            <td style="width:148px"> News Date </td>
                            <td style="width:148px"> News Source </td>
                          ...
                          <?php
							$counter = 0;
							$pagename = "agrinews.php?";
							$sql = "SELECT * FROM agrinews";
							$sql .= " ORDER BY weight";
							//echo $sql;
							$limit = 50;
							...
							{?>
                          		<tr <?php if($counter%2 != 0) echo 'bgcolor="#F7F7F7"'; else echo 'bgcolor="#FFFFFF"'; ?>>
                                    ...
                                    <td valign="top"><?= $row['newsDate'] ?></td>
                                    <td valign="top"><?= $row['newsSource'] ?></td>
                                    <td valign="top">
                            		<?
									$changeTo = 'Yes';
									if ($row['publish'] == 'Yes')
                            		...
                            		<td valign="top"> [ <a href="agrinews.php?type=edit&id=<?= $row['id']?>">Edit</a> | <a href="#" onClick="javascript: if(confirm('This will permanently remove this Agrinews from database. Continue?')){ document.location='agrinews.php?type=del&id=<?php echo $row['id']; ?>'; }">Delete</a> ]</td>
                          </tr>
                          <?
													}
													?>
