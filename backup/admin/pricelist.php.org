...
<?
	...
	for($i=0;$i<count($thok);$i++)
	{
		...
		$sql=mysqli_query($GLOBALS["___mysqli_ston"], "insert into pricelist set name='$name', unit='$unit', thokAverage='$thokAverage', khudraAverage='$khudraAverage', onDate='$onDate'");
