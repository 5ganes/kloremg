    ...
    <div id="bodydetail">
    	...
    	<div id="trip-box">
        	<div id="trip-box-in">
				...
				<? $tri="select * from groups where activity='$activity' and destination='$dest' order by weight"; $trip=mysqli_query($GLOBALS["___mysqli_ston"], $tri);
				while($tripsGet=mysqli_fetch_assoc($trip))
				{?>
                	<div class="trip-box">
							<h4>
								<a title="" href="">
