...
<div class="content">
    ...
    <div id="bodydetail">
    	...
    	<div id="trip-box">
        	<div id="trip-box-in">
        		<? $dname=$destGet['name']; ?>
				<? $ac=mysqli_query($GLOBALS["___mysqli_ston"], "select distinct activity from groups where linkType='Trip' and destination='$dname' order by weight");
				while($actGet=mysqli_fetch_assoc($ac))
				{
