...
<div class="content">
    ...
    <div id="bodydetail">
    	<div id="trip-box">
        	<div id="trip-box-in">
        		<? $act=$tripGet['name'];?>
				<? $t=mysql_query("SELECT * FROM groups WHERE linkType =  'Disease' AND activity =  '$act' ORDER BY weight");
				while($tGet=mysql_fetch_array($t))
				{?>
    ...
    <div id="bodydetail">
    	<div id="trip-box">
        	<div id="trip-box-in">
        		<? $act=$tripGet['name'];?>
				<? $t=mysql_query("SELECT * FROM groups WHERE linkType =  'Video' AND activity =  '$act' ORDER BY weight");
				while($tGet=mysql_fetch_array($t))
				{?>
