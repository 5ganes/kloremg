...
<div class="content">
	...
	<div class="rightnav">
    	<h2 style="margin: 0; margin-top: -7px; margin-left: 1%; margin-bottom: 1%">
    		<?php echo $actGet['name']; ?>
   		</h2>
    	<div class="">
    		<div style="margin:0; text-align: justify;line-height: 24px">
    			<a href="<?=SITE_URL.CMS_GROUPS_DIR.$actGet['image'];?>" target="_blank">
    				<img style="float: left; margin:3px 12px 0 0" src="<?=CMS_GROUPS_DIR.$actGet['image'];?>" width="360" height="250" />
    			</a>
    			<?php
